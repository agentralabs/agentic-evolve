...
## One-Liner (Default: Desktop Profile)
...
Installs binary and auto-configures detected MCP clients.
...
AgenticEvolve works as a fully standalone tool. No other Agentra sisters are required.
